view: dim_date {
  ...
  dimension: day_of_week_flag {
    type: number
    sql: ${TABLE}."day_of_week_flag" ;;
  }
  ...
  dimension_group: first_day_of_school_year {
    type: time
    timeframes: [
      raw,
      date,
    ...
    convert_tz: no
    datatype: date
    sql: ${TABLE}."first_day_of_school_year" ;;
  }
  ...
  dimension_group: last_day_of_school_year {
    type: time
    timeframes: [
      raw,
      date,
    ...
    convert_tz: no
    datatype: date
    sql: ${TABLE}."last_day_of_school_year" ;;
  }
  ...
  measure: count {
    type: count
    drill_fields: [quarter_name, month_name, day_name]
  }
}
