view: looker_rpt_writing_lesson_perf_overall_score_avg_writing_score_ {
  sql_table_name: tcdw.looker_rpt_writing_lesson_perf_overall_score_avg_writing_score_ ;;
